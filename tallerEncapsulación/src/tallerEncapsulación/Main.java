...
public class Main {
	public static void main(String[] args) {
		...
		listaProductos.add(new Producto("Jabon Rey", 3500.0, 45));
		listaProductos.add(new Producto("Zucaritas", 6500.0, 45));
		listaProductos.add(new Producto("Salsa de tomate", 6500.0, 45));
